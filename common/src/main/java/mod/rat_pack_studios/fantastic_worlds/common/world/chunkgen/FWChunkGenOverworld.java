...
public class FWChunkGenOverworld extends FWAbstractChunkGenerator
{
    ...
    public FWChunkGenOverworld(BiomeSource biomeSource, Holder<NoiseGeneratorSettings> settings)
    {
